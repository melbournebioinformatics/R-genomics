...
Use the `seq` function in conjunction with its `by` option to construct an index sequence. This can be used to extract every second row from the `data.frame`
